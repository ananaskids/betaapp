...
#define kCameraDirection    @"cameraDirection"
...
- (void)startCapture:(CDVInvokedUrlCommand *)command
{
    ...
    self.device = [self frontCamera];//YA [AVCaptureDevice defaultDeviceWithMediaType:AVMediaTypeVideo];
...
- (void)getOptions: (NSDictionary *)jsonData
{
    ...
    // cameraDirection
    obj = [jsonData objectForKey:kCameraDirection];
    if (obj != nil)
    {
        _cameraDirection = [obj intValue];
    }
...
static CGContextRef CreateCGBitmapContextForSize(CGSize size)
{
    ...
    context = CGBitmapContextCreate (NULL,
									 ...
									 //YA kCGImageAlphaPremultipliedLast);
