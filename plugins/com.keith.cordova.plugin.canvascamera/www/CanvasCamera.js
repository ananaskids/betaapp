...
cordova.define("cordova/plugin/CanvasCamera", function(require, exports, module) {
    ...
    CanvasCamera.prototype.doOrientationChange = function() {
        ...
        this._obj.width = 400 //windowWidth;// * pixelRatio;   /// resolution of canvas
        this._obj.height = 400 //windowHeight;// * pixelRatio;


        this._obj.style.width = '400px' //windowWidth + 'px';   /// CSS size of canvas
        this._obj.style.height = '400px' //windowHeight + 'px';


        this._x = 0;
        this._y = 0;
        this._width = 400 //windowWidth;
        this._height = 400 //windowHeight;
    };
